...
class MediaLibraryManager {
  ...
  async loadAllMediaData() {
    ...
    try {
      ...
      const tvShowsResponse = await fetch(
        "/components/MediaLibrary/data/tv-shows/media-library-tv-shows_normalized.json"
      );
  ...
  async loadSeasonEpisodeImages() {
    try {
      ...
      // Load unified TV shows data (combines thumbnails and video files)
      ...
      const seasonImagesResponse = await fetch(
        "/components/MediaLibrary/data/tv-shows/tv-show_season_images_normalized.json"
      );
      ...
      const episodeImagesResponse = await fetch(
        "/components/MediaLibrary/data/tv-shows/tv-show_episode_images_normalized.json"
      );

...
const SEASON_FILE = path.join(__dirname, '../public/components/MediaLibrary/data/tv-shows/tv-show_season_images.json');
const EPISODE_FILE = path.join(__dirname, '../public/components/MediaLibrary/data/tv-shows/tv-show_episode_images.json');

/*
  ...
  Created by Paul Welby (based on check_audio_codecs_tv-shows.js)
  Usage: node check_audio_codecs_tv-shows_SINGLE.js "Show Name" [Season Filter]
*/
...
// Paths
const MEDIA_LIBRARY_PATH = path.join(__dirname, '../public/components/MediaLibrary/data/tv-shows/media-library-tv-shows.json');
...
async function scanSingleTVShowWithSeason(showName, seasonFilter) {
    try {
        ...
        const allFiles = collectAllFilesFromTVShows(mediaLibraryData);
